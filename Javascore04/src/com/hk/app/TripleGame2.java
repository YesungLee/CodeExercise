...
public class TripleGame2 {
	...
	public static void main(String[] args) {
		...
		int choice1, choice2; // choice1 : 시스템 선택, choice2 : 상대방 선택
		// result1 : 시스템 결과, result2 : 상대방 결과, 
		String result1 = "", result2 = "", result3 = "", result4 = "";
		
		// 시스템의 선택
		choice1 = num.nextInt(49) + 1; // 50개의 구슬 중 랜덤한 숫자를 choice1에 저장
		if (choice1 % 3 == 1) {
			result1 = "어지";
		} else if (choice1 % 3 == 2) {
			result1 = "니";
		...
		if (result1 == result2) { // 시스템과 상대방의 선택이 동일하면
			if (result2 == result3) { // 시스템과 상대방의 선택이 동일하면 플레이어의 선택  같은지 한 번 더 비교
				result4 = "무승부"; // 시스템, 상대방, 플레이어의 선택이 모두 동일하면 무승부
			} else
			result4 = "상대방 승리";
